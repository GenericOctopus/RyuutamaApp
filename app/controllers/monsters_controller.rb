class MonstersController < ApplicationController
  ...
  private
    ...
    def monster_params
      params.require(:monster).permit(:name, :level, :habitat, :season, :materials, :dragonica, :hp, :mp, :initiative, :condition, :str, :dex, :int, :spi, :accuracy, :damage, :armor, :description, :specialability)
    end
end
